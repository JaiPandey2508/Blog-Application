...
const AddBlog = () => {
    ...
    const [isAdding, setIsAdding] = useState(false)//on clicking add button, it takes some time to add the blog, so we will show 'Adding...' on button and disable it to prevent multiple clicks
